...
namespace Azure.AI.TextAnalytics
{
    ...
    public static partial class TextAnalyticsModelFactory
    {
        ...
        public static ExtractSummaryResult ExtractSummaryResult(
            ...
            IEnumerable<TextAnalyticsWarning> warnings = default)
        {
            return new ExtractSummaryResult(id, statistics, sentences.ToList(), warnings.ToList());
        }
        ...
        public static AbstractSummaryResult AbstractSummaryResult(
            ...
            IEnumerable<TextAnalyticsWarning> warnings = default)
        {
            return new AbstractSummaryResult(id, statistics, summaries.ToList(), warnings.ToList());
        }
